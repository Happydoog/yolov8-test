...
cap = cv2.VideoCapture(f'vedio/A工事存储1_负二层B区-B131_20231111123500_20231111124559.avi')
...
while True:
    ...
    # cv2.line(frame, (614, cy1), (827, cy1), (255, 255, 255), 1)
    # cv2.putText(frame, ('L1'), (42, 337), cv2.FONT_HERSHEY_COMPLEX, 0.8, (0, 255, 255), 2)
    #
    # cv2.line(frame, (35, cy2), (732, cy2), (255, 255, 255), 1)
    # cv2.putText(frame, ('L2'), (615, 120), cv2.FONT_HERSHEY_COMPLEX, 0.8, (0, 255, 255), 2)
    # d = (len(counter))
    # u = (len(counter1))
